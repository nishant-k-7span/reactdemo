...
export default function About(props) {
  const myStyle = {
    ...
    backgroundColor: props.mode === "dark" ? "#111827" : "white",
  };

  return (
    <div id="accordion-collapse" data-accordion="collapse" style={myStyle}>
      ...
      >
        <div className="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
          <p className="mb-2 text-gray-500 dark:text-gray-100">
      ...
      >
        <div className="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
          ...
          <ul className="pl-5 text-gray-500 list-disc dark:text-gray-100">
            <li>
              <a
